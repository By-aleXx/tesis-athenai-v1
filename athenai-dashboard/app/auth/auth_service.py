...
def require_auth(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        # Fallback: leer desde httpOnly cookie cuando no hay header
        if not token:
            token = request.cookies.get('athenai_access_token')
...
auth_service_instance = None  # los consumidores externos usan current_app.config['AUTH_SERVICE']
