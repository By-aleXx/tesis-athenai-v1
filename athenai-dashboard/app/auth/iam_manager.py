...
def require_permission(permission: Permission):
    ...
    Must be stacked below @require_auth (from app.auth.auth_service), which
    authenticates the request first and sets request.user — this decorator
    only checks the permission, it does not verify the token itself.
