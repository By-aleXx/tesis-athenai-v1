...
# lambda_function_ml.py y su import 'models/*.pkl' asumen CWD == lambda/,
...
def main():
    ...
    import shutil
    _isolation_forest_src = os.path.join(_REPO_ROOT, 'training/models/isolation_forest.pkl')
    if os.path.exists(_isolation_forest_src):
        shutil.copy(_isolation_forest_src, 'models/')
